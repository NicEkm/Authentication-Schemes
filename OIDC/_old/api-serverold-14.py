...
async def get_auth_code_and_request_access_token(request):
    ...
    try: 
        ...
        tokenDict['id_token'] = id_token # Saves id_token for further use
        location = request.app.router['main6'].url_for()
...
app.add_routes([web.get('/', handle, name='main'),
                ...
                web.get('/api_data/auth_code/keycloak', handle5, name='main5'),
                web.get('/api_data/keycloak', handle6, name='main6'),
                web.post('/api_data/authorization_code', get_auth_code_and_request_access_token, name='auth_code'),
